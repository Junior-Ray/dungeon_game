package com.dungeon_game.core.combat;
...
import com.dungeon_game.core.model.Character;
...
public class AttackSystem {
    ...
    // O si prefieres movimiento más dramático:
    private final double[] dashDisplacementPerFrame = {
        0.0,   // Frame 1: preparación
        1.0,   // Frame 2: inicio
        4.0,   // Frame 3: EXPLOSIÓN DE VELOCIDAD
        3.0,   // Frame 4: mantiene velocidad
        2.0,   // Frame 5: reduciendo
        1.0,   // Frame 6: casi detenido
        0.0    // Frame 7: parado
    };
    ...
    */
    ...
    private void updateWeaponHitbox(int frameIndex) {
        List<List<Point>> weaponHitboxes = getWeaponHitboxesForType(currentAttackType);
